  ...
  return (
    <div className="w-11/12 md:w-full mx-auto mt-24 2xl:w-[1080px] ">
      <div className="flex justify-between items-center ">
        <h3>Ordenar por:</h3>
        <ul className="flex justify-center items-center gap-3 bg-stone-400 p-1 md:p-2 rounded-2xl">
          ...
          <li
            ...
            className={`px-1 py-2  rounded-xl text-sm md:text-base transition-all ${
              indexSelected === 1
